...
else: login_page()import streamlit as st
import pandas as pd
import plotly.express as px
import plotly.graph_objects as go
import datetime
...
def main_dashboard():
    ...
    with t4:
        ...
        with tab_ba:
            ...
            # Silakan edit angka dan tambahkan brand/toko lain sesuai kebutuhan aktual Anda.
            TARGET_BA_PER_BRAND = {
                "Careso": {
            ...
            # UI: Dropdown untuk memilih Brand
            ...
            if selected_ba_brand:
                # Ambil dictionary target khusus untuk brand yang dipilih
                current_target_dict = TARGET_BA_PER_BRAND[selected_ba_brand]
                
                # Filter Data: Hanya Brand yang dipilih, hanya Toko BA, dan hanya Tahun 2026
                ...
                # Buat kerangka dataframe target BA
                ...
                if not df_ba_all.empty:
                    ...
                    # Jika belum ada penjualan sama sekali, siapkan tabel dengan nilai Rp 0
                ...
                # Dropdown pemilihan bulan untuk view ala tabel JPG (Target | Pencapaian | ACHV %)
                ...
                # Hitung persentase achievement bulanan
                ...
                # Hitung Baris Grand Total Achievement
                ...
                # Render Tabel dengan Baris Bawah (Total) Bercetak Tebal dan Berwarna
