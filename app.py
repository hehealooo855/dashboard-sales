...
def load_data():
    # -------------------------------------------------------------
    # PENTING: PASTE LINK CSV GOOGLE SHEET ANDA DI SINI
    ...
    if 'Jumlah' in df.columns:
        # Hapus titik ribuan, buang desimal koma, ubah jadi angka
...
def main_dashboard():
    df = load_data()
    if df.empty:
        st.error("Gagal memuat data. Periksa Link Google Sheet Anda.")
        return

    # --- BAGIAN SIDEBAR (FILTER SYSTEM) ---
    with st.sidebar:
        st.image("https://cdn-icons-png.flaticon.com/512/3135/3135715.png", width=50) # Icon User
        ...
        # Menggunakan Multiselect agar bisa pilih "Medan" DAN "Binjai" sekaligus
        ...
        # 4. FILTER OUTLET (Wajib C - Cascading)
    ...
    if df_filtered.empty:
        ...
        with c_chart1:
            st.subheader("Tren Penjualan (Grafik Area)")
        ...
        with c_chart2:
            ...
            if 'Merk' in df_filtered.columns:
                ...
                fig2.update_traces(marker_color='#00897b') # Warna Teal/Hijau Elegan
