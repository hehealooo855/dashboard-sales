...
# ==========================================
# 2. DATABASE CONFIGURATION (FULL MONOLITH)
# ==========================================
# Disalin dari config.py agar tidak perlu file terpisah
...
BRAND_ALIASES = {
    "Diosys": ["DIOSYS", "DYOSIS", "DIO"], "Y2000": ["Y2000", "Y 2000", "Y-2000"], "Masami": ["MASAMI", "JAYA"], "Cassandra": ["CASSANDRA", "CASANDRA"], "Thai": ["THAI"], "Inesia": ["INESIA"], "Honor": ["HONOR"], "Vlagio": ["VLAGIO"], "Sociolla": ["SOCIOLLA"], "Skin1004": ["SKIN1004", "SKIN 1004"], "Oimio": ["OIMIO"], "Clinelle": ["CLINELLE", "CLIN"], "Ren & R & L": ["REN", "R & L", "R&L"], "Sekawan": ["SEKAWAN", "AINIE"], "Mad For Make Up": ["MAD FOR", "MAKE UP", "MAJU", "MADFORMAKEUP"], "Avione": ["AVIONE"], "SYB": ["SYB"], "Satto": ["SATTO"], "Liora": ["LIORA"], "Mykonos": ["MYKONOS"], "Somethinc": ["SOMETHINC"], "Gloow & Be": ["GLOOW", "GLOOWBI", "GLOW", "GLOWBE"], "Artist Inc": ["ARTIST", "ARTIS"], "Bonavie": ["BONAVIE"], "Whitelab": ["WHITELAB"], "Goute": ["GOUTE"], "Dorskin": ["DORSKIN"], "Javinci": ["JAVINCI"], "Madam G": ["MADAM", "MADAME"], "Careso": ["CARESO"], "Newlab": ["NEWLAB"], "Mlen": ["MLEN"], "Walnutt": ["WALNUT", "WALNUTT"], "Elizabeth Rose": ["ELIZABETH"], "OtwooO": ["OTWOOO", "O.TWO.O", "O TWO O"], "Saviosa": ["SAVIOSA"], "The Face": ["THE FACE", "THEFACE"], "Yu Chun Mei": ["YU CHUN MEI", "YCM"], "Milano": ["MILANO"], "Remar": ["REMAR"], "Beautica": ["BEAUTICA"], "Maskit": ["MASKIT"], "Claresta": ["CLARESTA"], "Birth Beyond": ["BIRTH"], "Rose All Day": ["ROSE ALL DAY"],
}

SALES_MAPPING = {
    "WIRA VG": "WIRA", "WIRA - VG": "WIRA", "WIRA VLAGIO": "WIRA", "WIRA HONOR": "WIRA", "WIRA - HONOR": "WIRA", "WIRA HR": "WIRA", "WIRA SYB": "WIRA", "WIRA - SYB": "WIRA", "WIRA SOMETHINC": "WIRA", "PMT-WIRA": "WIRA", "WIRA ELIZABETH": "WIRA", "WIRA WALNUTT": "WIRA", "WIRA ELZ": "WIRA", "HAMZAH VG": "HAMZAH", "HAMZAH - VG": "HAMZAH", "HAMZAH HONOR": "HAMZAH", "HAMZAH - HONOR": "HAMZAH", "HAMZAH SYB": "HAMZAH", "HAMZAH AV": "HAMZAH", "HAMZAH AINIE": "HAMZAH", "HAMZAH RAMADANI": "HAMZAH", "HAMZAH RAMADANI ": "HAMZAH", "HAMZA AV": "HAMZAH", "FERI VG": "FERI", "FERI - VG": "FERI", "FERI HONOR": "FERI", "FERI - HONOR": "FERI", "FERI THAI": "FERI", "FERI - INESIA": "FERI", "YOGI TF": "YOGI", "YOGI THE FACE": "YOGI", "YOGI YCM": "YOGI", "YOGI MILANO": "YOGI", "MILANO - YOGI": "YOGI", "YOGI REMAR": "YOGI", "GANI CASANDRA": "GANI", "GANI REN": "GANI", "GANI R & L": "GANI", "GANI TF": "GANI", "GANI - YCM": "GANI", "GANI - MILANO": "GANI", "GANI - HONOR": "GANI", "GANI - VG": "GANI", "GANI - TH": "GANI", "GANI INESIA": "GANI", "GANI - KSM": "GANI", "SSL - GANI": "GANI", "GANI ELIZABETH": "GANI", "GANI WALNUTT": "GANI", "MITHA MASKIT": "MITHA", "MITHA RAD": "MITHA", "MITHA CLA": "MITHA", "MITHA OT": "MITHA", "MAS - MITHA": "MITHA", "SSL BABY - MITHA ": "MITHA", "SAVIOSA - MITHA": "MITHA", "MITHA ": "MITHA", "LYDIA KITO": "LYDIA", "LYDIA K": "LYDIA", "LYDIA BB": "LYDIA", "LYDIA - KITO": "LYDIA", "NOVI AINIE": "NOVI", "NOVI AV": "NOVI", "NOVI DAN RAFFI": "NOVI", "NOVI & RAFFI": "NOVI", "RAFFI": "NOVI", "RAFI": "NOVI", "RAPI": "NOVI", "RAPI AV":"NOVI", "ROZY AINIE": "ROZY", "ROZY AV": "ROZY", "DANI AINIE": "DANI", "DANI AV": "DANI", "DANI SEKAWAN": "DANI", "MADONG - MYKONOS": "MADONG", "MADONG - MAJU": "MADONG", "MADONG MYK": "MADONG", "RISKA AV": "RISKA", "RISKA BN": "RISKA", "RISKA CRS": "RISKA", "RISKA E-WL": "RISKA", "RISKA JV": "RISKA", "RISKA REN": "RISKA", "RISKA R&L": "RISKA", "RISKA SMT": "RISKA", "RISKA ST": "RISKA", "RISKA SYB": "RISKA", "RISKA - MILANO": "RISKA", "RISKA TF": "RISKA", "RISKA - YCM": "RISKA", "RISKA HONOR": "RISKA", "RISKA - VG": "RISKA", "RISKA TH": "RISKA", "RISKA - INESIA": "RISKA", "SSL - RISKA": "RISKA", "SKIN - RIZKA": "RISKA", "ADE CLA": "ADE", "ADE CRS": "ADE", "GLOOW - ADE": "ADE", "ADE JAVINCI": "ADE", "ADE JV": "ADE", "ADE SVD": "ADE", "ADE RAM PUTRA M.GIE": "ADE", "ADE - MLEN1": "ADE", "ADE NEWLAB": "ADE", "DORS - ADE": "ADE", "FANDI - BONAVIE": "FANDI", "DORS- FANDI": "FANDI", "FANDY CRS": "FANDI", "FANDI AFDILLAH": "FANDI", "FANDY WL": "FANDI", "GLOOW - FANDY": "FANDI", "FANDI - GOUTE": "FANDI", "FANDI MG": "FANDI", "FANDI - NEWLAB": "FANDI", "FANDY - YCM": "FANDI", "FANDY YLA": "FANDI", "FANDI JV": "FANDI", "FANDI MLEN": "FANDI", "NAUFAL - JAVINCI": "NAUFAL", "NAUFAL JV": "NAUFAL", "NAUFAL SVD": "NAUFAL", "RIZKI JV": "RIZKI", "RIZKI SVD": "RIZKI", "SAHRUL JAVINCI": "SYAHRUL", "SAHRUL TF": "SYAHRUL", "SAHRUL JV": "SYAHRUL", "GLOOW - SAHRUL": "SYAHRUL", "SANTI BONAVIE": "SANTI", "SANTI WHITELAB": "SANTI", "SANTI GOUTE": "SANTI", "DWI CRS": "DWI", "DWI NLAB": "DWI", "ASWIN ARTIS": "ASWIN", "ASWIN AI": "ASWIN", "ASWIN Inc": "ASWIN", "ASWIN INC": "ASWIN", "ASWIN - ARTIST INC": "ASWIN", "BASTIAN CASANDRA": "BASTIAN", "SSL- BASTIAN": "BASTIAN", "SKIN - BASTIAN": "BASTIAN", "BASTIAN - HONOR": "BASTIAN", "BASTIAN - VG": "BASTIAN", "BASTIAN TH": "BASTIAN", "BASTIAN YL": "BASTIAN", "BASTIAN YL-DIO CAT": "BASTIAN", "BASTIAN SHMP": "BASTIAN", "BASTIAN-DIO 45": "BASTIAN", "SSL - DEVI": "DEVI", "SKIN - DEVI": "DEVI", "DEVI Y- DIOSYS CAT": "DEVI", "DEVI YL": "DEVI", "DEVI SHMP": "DEVI", "DEVI-DIO 45": "DEVI", "DEVI YLA": "DEVI", "SSL- BAYU": "BAYU", "SKIN - BAYU": "BAYU", "BAYU-DIO 45": "BAYU", "BAYU YL-DIO CAT": "BAYU", "BAYU SHMP": "BAYU", "BAYU YL": "BAYU", "HABIBI - FZ": "HABIBI", "HABIBI SYB": "HABIBI", "HABIBI TH": "HABIBI", "GLOOW - LISMAN": "LISMAN", "LISMAN - NEWLAB": "LISMAN", "WILLIAM BTC": "WILLIAM", "WILLI - ROS": "WILLIAM", "WILLI - WAL": "WILLIAM", "RINI JV": "RINI", "RINI SYB": "RINI", "FAUZIAH CLA": "FAUZIAH", "FAUZIAH ST": "FAUZIAH", "MARIANA CLIN": "MARIANA", "JAYA - MARIANA": "MARIANA"
}
...
def generate_daily_token():
    ...
    numeric_filter = filter(str.isdigit, hash_object.hexdigest())
    token = "".join(numeric_filter)[:4].ljust(4, '0')
    return token
...
def load_data():
    # --- PASTE LINK GOOGLE SHEET (PUBLISH TO WEB - CSV) DISINI ---
...
def compute_association_rules(df):
    ...
    return rules_df[rules_df['confidence'] > 0.5]
                ...
                if submitted:
                    ...
                    if users.empty: st.error("Database user (users.csv) tidak ditemukan.")
                        ...
                        if match.empty:
                            ...
                            is_authorized = False
                            if user_role in ['direktur', 'manager']: is_authorized = True
                            else:
                                if otp_input == daily_token: is_authorized = True
                                else:
...
def main_dashboard():
    ...
    def add_aggressive_watermark():
        ...
        if role_name != 'direktur':
            ...
            document.addEventListener('keydown', (e) => {{ if ((e.ctrlKey || e.metaKey) && (e.key === 'p' || e.key === 's')) {{ e.preventDefault(); alert('⚠️ Action Disabled!'); }} }});
            </script>
            """, unsafe_allow_html=True)
    add_aggressive_watermark()

    if st.session_state['role'] != 'direktur':
        st.markdown("""<style>@media print { body { display: none !important; } } body { -webkit-user-select: none; user-select: none; } img { pointer-events: none; }</style>""", unsafe_allow_html=True)

    # --- SIDEBAR (KEMBALI KE POSISI SEMULA) ---
    with st.sidebar:
        st.write("## 👤 User Profile")
        st.info(f"**{st.session_state['sales_name']}**\n\nRole: {st.session_state['role'].upper()}")
        
        # --- MENU KHUSUS DIREKTUR/MANAGER ---
    ...
    # --- FILTER PERIODE (DIPINDAHKAN KE ATAS AGAR TIDAK HILANG SAAT DATA ERROR) ---
    ...
    if df is None or df.empty:
        st.error("⚠️ Data tidak ditemukan atau Link Google Sheet (CSV) bermasalah. Pastikan 'Publish to Web' aktif.")
        return

    # --- SECURITY SCOPING ---
    df_active = df
    
    # Filter Berdasarkan Tanggal (Logic Tambahan untuk CSV Monolith)
    df_active = df_active[(df_active['Tanggal'].dt.date >= start_date) & (df_active['Tanggal'].dt.date <= end_date)]
    ...
    if user_role not in ['manager', 'direktur', 'supervisor'] and user_name.lower() != 'fauziah':
        df_active = df_active[df_active['Penjualan'] == user_name]
    elif user_name.upper() in TARGET_DATABASE: 
         spv_brands = list(TARGET_DATABASE[user_name.upper()].keys())
         df_active = df_active[df_active['Merk'].isin(spv_brands)]
    ...
    c1.metric(label="💰 Total Omset (Periode)", value=format_idr(current_omset_total))
    ...
    if role in ['manager', 'direktur'] or is_supervisor_account or target_sales_filter in INDIVIDUAL_TARGETS or target_sales_filter.upper() in TARGET_DATABASE:
        ...
        if target_sales_filter == "SEMUA":
            realisasi_nasional = df['Jumlah'].sum()
        ...
        if loop_source and (target_sales_filter == "SEMUA" or target_sales_filter.upper() in TARGET_DATABASE):
            ...
            for spv, brands_dict in loop_source:
                for brand, target in brands_dict.items():
                    ...
                    brand_row = {"Rank": 0, "Item": brand, "Supervisor": spv, "Target": format_idr(target), "Realisasi": format_idr(realisasi_brand), "Ach (%)": f"{pct_brand:.0f}%", "Bar": pct_brand / 100, "Progress (Detail %)": pct_brand}
                    sales_rows_list = []
                    for s_name, s_targets in INDIVIDUAL_TARGETS.items():
                        if brand in s_targets:
                            ...
                            sales_rows_list.append({"Rank": "", "Item": f"   └─ {s_name}", "Supervisor": "", "Target": format_idr(t_indiv), "Realisasi": format_idr(r_indiv), "Ach (%)": f"{pct_indiv:.0f}%", "Bar": pct_indiv / 100, "Progress (Detail %)": pct_brand})
    ...
    with t_detail_sales:
        ...
        if allowed_brands:
            ...
            if selected_brand_detail:
                sales_stats = []
                total_brand_sales = 0; total_brand_target = 0
                today = datetime.date.today()
                # Simplified date logic for display
                if len(date_range) == 2:
                    start_d, end_d = date_range; total_days = (end_d - start_d).days + 1
                    if end_d < today: days_gone = total_days
                    elif start_d > today: days_gone = 0
                    else: days_gone = (today - start_d).days + 1; days_gone = max(0, min(days_gone, total_days))
                ...
                for sales_name, targets in INDIVIDUAL_TARGETS.items():
                    if selected_brand_detail in targets:
                        ...
                        else: expected_ach = 0; gap = 0

                        sales_stats.append({"Nama Sales": sales_name, "Target Pribadi": format_idr(t_pribadi), "Realisasi": format_idr(real_sales), "Ach %": f"{(real_sales/t_pribadi)*100:.1f}%", "Expected (Time Gone)": format_idr(expected_ach), "Gap": format_idr(gap), "_real": real_sales, "_target": t_pribadi})
    ...
    with t3:
        ...
        col_pareto1.metric("Total Produk Unik", len(pareto_df)); col_pareto2.metric("Produk Kontributor Utama (80%)", len(top_performers))
        ...
        with c1:
            ...
            fig_bar = px.bar(top_prod, x='Jumlah', y='Nama Barang', orientation='h', text_auto='.2s'); fig_bar.update_layout(yaxis={'categoryorder':'total ascending'}); st.plotly_chart(fig_bar, use_container_width=True)
        with c2:
            st.subheader("🏪 Top 10 Outlet")
            top_out = df_active.groupby('Nama Outlet')['Jumlah'].sum().nlargest(10).reset_index()
            fig_out = px.bar(top_out, x='Jumlah', y='Nama Outlet', orientation='h', text_auto='.2s', color_discrete_sequence=['#27ae60']); fig_out.update_layout(yaxis={'categoryorder':'total ascending'}); st.plotly_chart(fig_out, use_container_width=True)
            
    with t5:
        st.subheader("🚀 Kejar Omset (Actionable Insights)")
        st.write("#### 🚨 Toko Tidur (Potensi Hilang)")
        all_outlets = df_scope_all['Nama Outlet'].unique(); active_outlets = df_active['Nama Outlet'].unique(); sleeping_outlets = list(set(all_outlets) - set(active_outlets))
        if sleeping_outlets:
            ...
            with st.expander("Lihat Daftar Toko Tidur"):
                ...
                df_sleep = pd.DataFrame(last_trx).sort_values("Hari Sejak Order Terakhir"); st.dataframe(df_sleep, use_container_width=True)
        else: st.success("Luar biasa! Semua toko langganan sudah order di periode ini.")
        ...
        if len(relevant_brands) > 1:
            ...
            with col_cs2: target_options = [b for b in relevant_brands if b != brand_acuan]; brand_target = st.selectbox("Tapi BELUM beli Brand:", sorted(target_options), index=0 if target_options else None)
            if brand_target:
                outlets_buy_acuan = df_active[df_active['Merk'] == brand_acuan]['Nama Outlet'].unique(); opportunities = []
                ...
                else: st.success(f"Hebat! Semua toko yang beli {brand_acuan} juga sudah membeli {brand_target}.")
        else: st.info("Data tidak cukup untuk analisa cross-selling (perlu minimal 2 brand aktif).")
        
        st.divider(); st.write("#### 🧠 Rekomendasi Cross-Selling Cerdas")
        recs_df = get_cross_sell_recommendations(df_scope_all)
        if recs_df is not None and not recs_df.empty: st.success(f"Ditemukan {len(recs_df)} rekomendasi cerdas."); st.dataframe(recs_df, use_container_width=True)
        else: st.info("Tidak ada rekomendasi cerdas yang memenuhi threshold (confidence > 50%).")
            
    with t_forecast:
        st.subheader("🔮 Prediksi Omset (Forecasting)"); st.info("Prediksi tren omset 30 hari ke depan berdasarkan data historis harian.")
        df_forecast = df_scope_all.groupby('Tanggal')['Jumlah'].sum().reset_index(); df_forecast = df_forecast.sort_values('Tanggal')
        if len(df_forecast) > 10:
            ...
            last_date = df_forecast['Tanggal'].max(); future_days = 30
            future_dates = [last_date + datetime.timedelta(days=i) for i in range(1, future_days + 1)]; future_ordinals = [d.toordinal() for d in future_dates]
            future_values = p(future_ordinals)
            df_history = df_forecast[['Tanggal', 'Jumlah']].copy(); df_history['Type'] = 'Historis'
            df_future = pd.DataFrame({'Tanggal': future_dates, 'Jumlah': future_values}); df_future['Type'] = 'Prediksi'
            ...
            fig_forecast.update_layout(title="Proyeksi Omset 30 Hari Kedepan", xaxis_title="Tanggal", yaxis_title="Omset"); st.plotly_chart(fig_forecast, use_container_width=True)
            trend = "NAIK 📈" if z[0] > 0 else "TURUN 📉"; st.write(f"**Analisa Tren:** Berdasarkan data historis, tren penjualan terlihat **{trend}**.")
    ...
    with t4:
        ...
        if user_role_lower in ['direktur', 'manager', 'supervisor']:
            ...
            with pd.ExcelWriter(output, engine='xlsxwriter') as writer:
                ...
                workbook = writer.book; worksheet = writer.sheets['Sales Data']
                user_identity = f"{st.session_state['sales_name']} ({st.session_state['role'].upper()})"; time_stamp = datetime.datetime.now().strftime("%Y-%m-%d %H:%M:%S")
                watermark_text = f"CONFIDENTIAL DOCUMENT | TRACKED USER: {user_identity} | DOWNLOADED: {time_stamp} | DO NOT DISTRIBUTE"
                worksheet.set_header(f'&C&10{watermark_text}'); worksheet.set_footer(f'&RPage &P of &N')
                format1 = workbook.add_format({'num_format': '#,##0'}); worksheet.set_column('F:F', None, format1)
            st.download_button(label="📥 Download Laporan Excel (XLSX) - DRM Protected", data=output.getvalue(), file_name=f"Laporan_Sales_Protected_{datetime.date.today()}.xlsx", mime="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet")
        elif role in ['direktur']: 
             csv = df_active[final_cols].to_csv(index=False).encode('utf-8'); file_name = f"Laporan_Sales_{datetime.date.today()}.csv"
