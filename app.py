...
def main_dashboard():
    ...
    with t4:
        ...
        st.download_button(label="📥 Download Laporan (CSV)", data=csv, file_name=f"Laporan_Sales_{datetime.date.today()}.csv", mime="text/csv", type="primary")
