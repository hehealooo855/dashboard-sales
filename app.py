...
# ==========================================
# 2. KONFIGURASI TARGET (SUPERVISOR & INDIVIDU)
# ==========================================

# Target Supervisor (Hanya melihat Brand mereka sendiri)
TARGET_DATABASE = {
    "MADONG": {
...
# ==========================================
# 3. DATA CLEANING & MAPPING DICTIONARIES
# ==========================================
            ...
            with st.form("login_form"):
                ...
                if submitted:
                    try:
                        ...
                        st.error("File secrets.toml tidak ditemukan. Jalankan setup_security.py terlebih dahulu.")
