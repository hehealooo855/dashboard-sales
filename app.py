...
# --- DATABASE TARGET (UPDATED SESUAI REQUEST) ---
TARGET_DATABASE = {
    "LISMAN": {
        "Javinci": 1_300_000_000, 
        "Careso": 400_000_000,
        "Gloow & Be": 130_000_000,
        "Dorskin": 20_000_000,
        ...
        "Bonavie": 50_000_000, 
        "Goute": 50_000_000,
        "Madam G": 100_000_000 # Keep existing (tidak di-mention ubah/hapus)
    },
    "AKBAR": {
        "Thai": 300_000_000, 
        "Inesia": 100_000_000, 
        "Honor": 100_000_000, # Split dari 200jt
        "Vlagio": 100_000_000, # Split dari 200jt
        "Diosys": 550_000_000, 
        "Y2000": 150_000_000, 
        "Sociolla": 600_000_000, 
        "Skin1004": 300_000_000,
        "Masami": 40_000_000, 
    ...
    "MADONG": {
        ...
        "Mykonos": 20_000_000, 
        "Ren & R & L": 20_000_000, 
        "Avione": 250_000_000, # Keep existing
        "Liora": 0
    }
}

# --- HITUNG TOTAL TARGET OTOMATIS (AGAR SELALU AKURAT) ---
...
BRAND_ALIASES = {
    ...
    "Careso": ["CARESO"], "Newlab": ["NEWLAB"], "Mlen": ["MLEN", "MILEN"],
